...
(function($) {
    ...
    $.fn.extend({
        ...
        uploader: function(options) {
            var settings = {
                url: '/shopxxb2b2c-5.0.2-SNAPSHOT/admin/file/upload',
                fileType: "image",
                fileName: "file",
                data: {},
                maxSize: 10,
            ...
            return this.each(function() {
                ...
                var webUploader = WebUploader.create({
                    swf: '/shopxxb2b2c-5.0.2-SNAPSHOT/resources/admin/flash/webuploader.swf',
        ...
        editor: function(options) {
            window.UEDITOR_CONFIG = {
                UEDITOR_HOME_URL: '/shopxxb2b2c-5.0.2-SNAPSHOT/resources/admin/ueditor/',
                serverUrl: '/shopxxb2b2c-5.0.2-SNAPSHOT/admin/file/upload',
